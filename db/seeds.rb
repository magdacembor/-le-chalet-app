...
{ name: "Chalet d'Or", description: "Lovely chalet with breathtaking mountain views just outside Verbier. Big balcony with lots of morning sun. A perfect place for couples or friends to spend quality time in one of the world's best ski resorts.", address: "Verbier, Switzerland", number_of_guests: 3, number_of_bedrooms: 1, price: 250, user_id: 1 },
{ name: "Chalet de Grands Montets", description: "Great 2-bedroom chalet. Very quiet and private, garage, garden. Close to the center of Chamonix and the iconic Grands Montets, true ski in ski out.", address: "Chamonix, France", number_of_guests: 5, number_of_bedrooms: 2, price: 400, user_id: 2 },
...
{ name: "Vue Montana", description: "The chalet is located 2 minutes away from the local town and 5 minutes away from the Medran ski lift. The chalet has a large living room with flat screen TV, Wi-Fi and soft furnishings. There is a good sized Italian bathroom, parking, ski lockers and access to a washing machine and dryer.", address: "Crans-Montana, Switzerland", number_of_guests: 8, number_of_bedrooms: 3, price: 550, user_id: 2 },
{ name: "Chalet la Grande Journée", description: "Chalet la Grande Journée is located a few minutes away from the main ski lift. One of the few chalets directly accessible by ski from the main run to the Ruinettes ski-lift. It easily houses four adults and is comfortable for a family of five persons.", address: "Verbier, Switzerland", number_of_guests: 5, number_of_bedrooms: 2, price: 350, user_id: 4 },
